...
public class FournisseurInformation extends AppCompatActivity {
    DatabaseHelper db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fournisseur_information);
        ...
        final ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(FournisseurInformation.this,android.R.layout.simple_list_item_1,getResources().getStringArray(R.array.licenseds));
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (s1.equals("") || s2.equals("") || s3.equals("") || s4.equals("")|| s5.equals("--Choisir Licensed--")) {
                    ...
                    if (insert == true) {
                        ...
                        Intent i = new Intent(FournisseurInformation.this, FournisseurServiceFromAdmin.class);
